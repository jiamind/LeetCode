...
public class MeetingRoomsII {
    ...
    public int minMeetingRooms(Interval[] intervals) {
        ...
        // It will return the earlist end time of all meeting rooms currently in use
        ...
        for (int i = 1; i < intervals.length; i++){
            ...
            // If the start time of the current interval is greater than the earlist ending meeting room
